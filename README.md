...
# A few cons of me:
## StructuroPhile:
--- i love structure, i turn everything into a logical hierarchy or tree, without structure i panic
--- i dont like uncertainity at all so i give it all i collect data all the time to reduce uncertainity, basically control freak
